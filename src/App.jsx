  ...
  return (
    <div className="app">
      ...
      <style>{`
        ...
        .toast-text { color: #f1f1f1; font-size: 0.9rem; font-weight: 500; font-family: var(--font-body); }

        /* ===== NEW: ADD DONOR BUTTON ===== */
        .add-donor-btn {
          background: var(--red);
          color: white;
          border: none;
        ...
        .close-btn:hover { color: var(--red-bright); }

        .donor-form { display: flex; flex-direction: column; gap: 1.2rem; }
        ...
        .toggle-label-form input { display: none; }
        .custom-checkbox {
          width: 20px;
          height: 20px;
        ...
        .toggle-label-form input:checked + .custom-checkbox {
          background: var(--red);
          border-color: var(--red);
        }
        .toggle-label-form input:checked + .custom-checkbox::after {
          content: '✓';
          position: absolute;
          color: white;
          font-size: 14px;
        ...
        .btn-cancel:hover { background: var(--surface-3); color: var(--text-primary); }
        ...
        .btn-submit:hover { background: var(--red-bright); box-shadow: 0 0 15px rgba(220, 38, 38, 0.4); }

        /* ===== RESPONSIVE ===== */
        @media (max-width: 768px) {
          .stats-bar { flex-wrap: wrap; justify-content: center; }
          .hide-mobile { display: none; }
          .add-donor-btn { width: 100%; margin-top: 0.5rem; }
        }
